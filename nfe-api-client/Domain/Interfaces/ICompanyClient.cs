...
namespace nfe.api.client.Domain.Interfaces
{
    public interface ICompanyClient
    {
        ...
        Task<IEnumerable<Result<LegalPerson>>> GetAsync(System.Threading.CancellationToken cancellationToken);

        /// <summary>Criar uma empresa</summary>
        /// <param name="item">Dados da empresa</param>
        /// <returns>Sucesso na criação da empresa</returns>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        Task<Result<LegalPerson>>  PostAsync(LegalPerson item, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>Sucesso na requisição</returns>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        Task<Result<LegalPerson>>  GetOneAsync(string company_id_or_tax_number, System.Threading.CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        Task<Result<LegalPerson>>  PutAsync(string company_id, LegalPerson item, System.Threading.CancellationToken cancellationToken);

        /// <summary>Excluir uma empresa</summary>
        /// <param name="company_id">ID da empresa</param>
        /// <returns>Sucesso na remoção da empresa</returns>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        Task<Result<LegalPerson>> DeleteAsync(string company_id, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>Sucesso na atualização da empresa</returns>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        Task<Result<string>> CertificateUploadAsync(string company_id, byte[] file, string password, System.Threading.CancellationToken cancellationToken);
    }
}
